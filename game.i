        ...
        case SHOOTER:
            for (int i = 0; i < 5; i++) {
                if (shooters[i].state == ENEMYSTATE_INACTIVE) {
                    ...
                    shooters[i].attackStep = rand() % 60 - 10;
                    shooters[i].hide = 0;
...
void updateEnemies() {
    ...
    for (int i = 0; i < 5; i++) {
        if (wraiths[i].state != ENEMYSTATE_INACTIVE) {
            ...
            } else if (wraiths[i].worldRow + wraiths[i].height <= 224 - 18) {
            ...
            if (wraiths[i].rowStep >= 10) {
                wraiths[i].rowStep -= 10;
                wraiths[i].worldRow--;
                if (wraiths[i].worldRow + wraiths[i].height <= 224 - 18) {
                    wraiths[i].rowStep = 0;
                    wraiths[i].rowVelocity = 0;
                }
            }
